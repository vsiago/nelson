...
export default function Home() {
  return (
    <div className="bg-[#243B1E] min-h-screen text-white flex items-center flex-col px-8">
      ...
      <main className="flex-1 w-full">
        <section className="w-full mt-10 rounded-lg grid grid-cols-3 gap-3 items-center justify-center">
          <div className="bg-[#58854C] border-2 border-[#85D186] h-[110px] rounded-3xl flex justify-center items-center text-[#DCFFDC] text-center">
